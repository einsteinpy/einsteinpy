...
def test_calculate_trajectory2_schwarzschild():
    ...
    sph = SphericalDifferential(
        e0=0.0 * u.s,
        e1=distance_at_perihelion * u.m,
        e2=np.pi / 2 * u.rad,
        e3=0.0 * u.rad,
        u0=0.0 * u.m / u.s,
        u1=0.0 * u.rad / u.s,
        u2=angular_vel * u.rad / u.s,
    )
