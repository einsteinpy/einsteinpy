...
from . import coord_transforms as sph
...
def BLToSpherical_pos(pos_vec, a):
    ...
    """
    r_vec = BLToCartesian_pos(pos_vec, a)
...
def BLToSpherical_vel(pos_vec, vel_vec, a):
    ...
    v_vec = BLToCartesian_vel(pos_vec, vel_vec, a)
...
def SphericalToBL_pos(pos_vec, a):
    ...
    r_vec = CartesianToBL_pos(r_vec, a)
...
def SphericalToBL_vel(pos_vec, vel_vec, a):
    ...
    v_vec = CartesianToBL_vel(r_vec, v_vec, a)
...
def S2BL_units(pos_vec, vel_vec, a):
    ...
    npos_vec, nvel_vec = C2BL_units(npos_vec, nvel_vec, a)
...
def BL2S_units(pos_vec, vel_vec, a):
    ...
    """
    npos_vec, nvel_vec = BL2C_units(pos_vec, vel_vec, a)
