...
class StaticGeodesicPlotter:
    ...
    def parametric_plot(
        self, geodesic, figsize=(8, 6), colors=("#00FFFF", "#FF00FF", "#00FFFF")
    ):
        """
    ...
    def animate(
        ...
        ax.set_xlim3d([x_min - margin_x, x_max + margin_x])
        ax.set_ylim3d([y_min - margin_y, y_max + margin_y])
        ax.set_zlim3d([z_min - margin_z, z_max + margin_z])
