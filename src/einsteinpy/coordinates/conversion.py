...
class SphericalConversion:
    ...
    def convert_ief(self, **kwargs):
        """
        Converts to ingoing Eddington-Finkelstein Coordinates
        ...
        **kwargs : dict
        ...
        ------
        KeyError
            If ``kwargs`` does not contain ``M`` as keyword argument
        """
        try:
            M = kwargs["M"]
        except KeyError:
...
class IngoingEddingtonFinkelsteinConversion:
    """
    Class for conversion to and from ingoing Eddington-Finkelstein Coordintaes in SI units
    ...
    def __init__(self, v, r, theta, phi, v_r=None, v_th=None, V_p=None):
        ...
        ----------
        v : float
            Timelike coordinate in Eddington-Finkelstein Coordinates
        r : float
            r-Component of 3-Position
        theta : float
            theta-Component of 3-Position
    ...
    def values(self):
        ...
        return self.v_si, self.r_si, self.th_si, self.p_si
    ...
    def convert_spherical(self, **kwargs):
        ...
        **kwargs : dict
            Keyword Arguments
            Expects two arguments, ``M``, as described below
    ...
    def convert_ks(self, **kwargs):
        """
        Converts to Kerr-Schild Coordinates
