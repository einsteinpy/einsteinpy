...
def AlcubierreWarp(
    ...
    .. [1] Classical and Quantum Gravity, "The warp drive: hyper-fast travel within general relativity", Miguel Alcubierre, 1994, **11(5)**, pp. 73-77
    ...
    sigma : ~sympy.core.basic.Basic or int or float
        Arbitrary Parameter (See the paper)
